...
class ECG:
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		loaded_model = joblib.load(r'D:\Top_Tech_Developers\Source Code\Source Code\model.pkl')
		result = loaded_model.predict(final_df)
		if result[0] == 1:
			return "You ECG corresponds to Myocardial Infarction \U0001F3E5"
		elif result[0] == 0:
			return "You ECG corresponds to Abnormal Heartbeat \U0001F3E5"
		elif result[0] == 2:
			return "Your ECG is Normal \U00002764\U0000FE0F"
		else:
			return "You ECG corresponds to History of Myocardial Infarction \U0001F3E5"
# st.markdown('\U0001F3E5')