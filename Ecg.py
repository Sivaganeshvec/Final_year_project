...
class ECG:
	...
	def DimensionalReduciton(self,test_final):
		...
		#pca_loaded_model = joblib.load('D:\\Top_Tech_Developers\\Project_Cardiovascular\\Deployment\\Deployment\\PCA_ECG.pkl')
		pca_loaded_model = joblib.load('D:\\SARASI_PROJECT\\Project_Cardiovascular\\Deployment\\Deployment\\PCA_ECG.pkl')
	...
	def ModelLoad_predict(self,final_df):
		...
		#loaded_model = joblib.load('D:\\Top_Tech_Developers\\Project_Cardiovascular\\Deployment\\Deployment\\Heart_Disease_Prediction_using_ECG.pkl')
		loaded_model = joblib.load('D:\\SARASI_PROJECT\\Project_Cardiovascular\\Deployment\\Deployment\\Heart_Disease_Prediction_using_ECG.pkl')
